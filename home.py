...
def app():
    ...
    post_butt=st.button('Post',use_container_width=20)
    
    if post_butt and st.session_state["signedout"] :
        if post!='':
    ...
    elif post_butt and not st.session_state["signedout"]:
       st.warning("You can't post anything without login")
